...
| 整合包版本 | 整合包的方向 | 整合目标 |
| :-: | :- | :- |
| [基础 ( Basis )](https://github.com/Minecraft-Origin/Minecraft-Origin/tree/基础) | 原版 | 不对原版进行任何修改, 进行游戏体验及界面视听进行优化, 可以直接进入纯净服 |
| [基础+ ( Basis+ )](https://github.com/Minecraft-Origin/Minecraft-Origin/tree/基础+) | 原版扩展 | 不对游戏添加任何物品, 对游戏玩法进行大幅改善优化, 降低游戏难度, 获得全新的体验 |
| [增强 ( Enhance )](https://github.com/Minecraft-Origin/Minecraft-Origin/tree/增强) | 游戏增强 | 添加各种模组, 对游戏各个方面进行强化, 同时增强游戏难度 |
| [极限 ( Ultimate_Limit )](https://github.com/Minecraft-Origin/Minecraft-Origin/tree/极限) | 科技 | 添加大量科技模组, 再度增强游戏难度 |
<br>
...
| 自动钓鱼 - [Autofish](https://www.minecraftforum.net/forums/mapping-and-modding-java-edition/minecraft-mods/2530407-autofish-forge-mod-for-minecraft-1-14-1-13-1-12-1) | 自行汉化版<br>拿着钓竿钓鱼时上钩后会自动收杆并在此抛出, 使用快捷键 <b>`V`</b> 进行配置及禁用 |
...
| 建筑小帮手 - [Building Gadgets](https://www.curseforge.com/minecraft/mc-mods/building-gadgets) | 加强的建筑工具<br>手持筑小帮手工具使用 `G` 键可以打开 GUI 使用各种功能 |
...
| 木质漏斗 - [Wopper](https://www.curseforge.com/minecraft/mc-mods/wopper) | 一款木质的, 无缓存的漏斗 |
