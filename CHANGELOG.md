  ...
  - 🆙 [ 极限 ] 更新 `< 压缩工具 / ExCompressum >`, `< 通用机械矿石 / MekanismOres >`, `< 建筑 / Buildcraft >`, `< 沉浸工程 / Immersive Engineering >`, `< 植物魔法 / Botania >`, `< 末影核心 / EnderCore >`, `< 末影接口 / Ender IO >`, `< 末影接口 - 管道拓展 / Ender IO Endergy >`, `< 懒惰的AE2 / Lazy AE2 >`, `< LibNine >`, `< 热力膨胀 / Thermal Expansion >`, `< 热力膨胀 - 基础 / Thermal Foundation >`, `< 热力膨胀 - 动力学 / Thermal Dynamics >`, `< 热力膨胀 - 农业 / Thermal Cultivation >` 模组
